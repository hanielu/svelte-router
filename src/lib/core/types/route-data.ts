...
} from "../dom/ssr/routeModules.js";
import type { DataWithResponseInit } from "../router/utils.js";
import type { Serializable } from "../server-runtime/single-fetch.js";
import type { RouteModule } from "./route-module.js";
import type { unstable_SerializesTo } from "./serializes-to.js";
import type { Equal, Expect, Func, IsAny, Pretty } from "./utils.js";
...
type __tests = [
  ...
  Expect<
    Equal<
      Pretty<
        ...
        >
      >,
      { json: string; b: Date; c: () => boolean } | { data: string; b: Date; c: () => boolean }
    >
  >,
  ...
  Expect<
    Equal<
      ...
      { a: string; b: Date; c: undefined } | { d: string; e: Date; f: () => boolean }
    >
  >,
  Expect<
    Equal<
